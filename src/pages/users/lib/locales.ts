export const locales = {
    ...
    menuReportUnblock: "pages.user-list.menu-report-unblock",
    reportBlockDescription: "pages.user-list.report-block-description",
    reportBlockReasonPlaceholder: "pages.user-list.report-block-reason-placeholder",
    reportBlockCancel: "pages.user-list.report-block-cancel",
    reportBlockedShort: "pages.user-list.report-blocked-short",
    showReportBlocked: "pages.user-list.showReportBlocked",
    menuReportController: "pages.user-list.menu-report-controller",
    menuReportControllerClear: "pages.user-list.menu-report-controller-clear",
    reportControllerDescription: "pages.user-list.report-controller-description",
    ...
    dashboardReportBlocked: "pages.user-list.dashboard.reportBlocked",
